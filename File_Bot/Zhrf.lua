local function Zhrf(msg)
local text = msg.content_.text_
if not database:get(bot_id..'Zhrf:Status'..msg.chat_id_) then
if text == "زخرفه" or text == "زخرفلي"  then  
redis:setex(ninja9..":ZhrfNow:"..msg.sender_user_id_,500,true)
sendMsg(msg.chat_id_,msg.id_,"📑| حسننا , الان يمكنك ارسال الاسم 💯")    
return false
end

if redis:get(ninja9..":ZhrfNow:"..msg.sender_user_id_) then
redis:del(ninja9..":ZhrfNow:"..msg.sender_user_id_)
...
if msg.text and msg.type ~= "pv" and redis:get(ninja9..":ZhrfNow:"..msg.sender_user_id_) then
Text = msg.text
redis:del(ninja9..":ZhrfNow:"..msg.sender_user_id_)
if utf8.len(msg.text) > 300 then
...
text == 'تفعيل الزخرفه' and Manager(msg) then
database:del(bot_id..'Zhrf:Status'..msg.chat_id_)
send(msg.chat_id_, msg.id_,'🚸|تم تفعيل الزخرفه')
return false
end

if text == 'تعطيل الزخرفه' and Manager(msg) then
database:set(bot_id..'Zhrf:Status'..msg.chat_id_,true)
