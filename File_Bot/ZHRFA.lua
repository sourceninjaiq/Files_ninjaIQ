...
if devNINJA:get(DEVNINJA.."skrafa:name" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then   
if text and text:match("^الغاء$") then 
NINJA_sendMsg(msg.chat_id_, msg.id_, 1, "*💥¦* تم الغاء امر الزخرفه ✔", 1, "md")
devNINJA:del(DEVNINJA.."skrafa:name" .. msg.chat_id_ .. "" .. msg.sender_user_id_)     
return false
end
if text then
if utf8.len(text) > 20 then
NINJA_sendMsg(msg.chat_id_, msg.id_, 1,'*📮¦ لا يمكن زخرفة اكثر من 20 حرف *', 1, 'md') 
devNINJA:del(DEVNINJA.."skrafa:name" .. msg.chat_id_ .. "" .. msg.sender_user_id_)     
return false
end
...
NINJA_sendMsg(msg.chat_id_, msg.id_, 1, SEND_SKRF,  1, "md")
devNINJA:del(DEVNINJA.."skrafa:name" .. msg.chat_id_ .. "" .. msg.sender_user_id_)     
end
end
end
...
if devNINJA:get(DEVNINJA..'lock:skrfa'..msg.chat_id_)  then
taha = '*📮¦ تم تفعيل الزخرفه *\n✓' 
NINJA_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
devNINJA:del(DEVNINJA..'lock:skrfa'..msg.chat_id_) 
else
...
if not devNINJA:get(DEVNINJA..'lock:skrfa'..msg.chat_id_)  then
taha = '*📮¦ تم تعطيل الزخرفه *\n✓' 
NINJA_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
devNINJA:set(DEVNINJA..'lock:skrfa'..msg.chat_id_,true) 
else
...
if MSG_TEXT[1] == ("زخرفه") or MSG_TEXT[1] == ("زخرفة") or MSG_TEXT[1] == ("زخرف") then
if not devNINJA:get(DEVNINJA.."lock:skrfa"..msg.chat_id_) then   
devNINJA:setex(DEVNINJA.."skrafa:name" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)   
local t = '*⚡¦* ارسل الاسم الذي تريد زخرفته \n*📬¦* سواء كان بالعربي او بالانكلش 🍁'   
NINJA_sendMsg(msg.chat_id_, msg.id_, 1,t, 1, 'md') 
else
NINJA_sendMsg(msg.chat_id_, msg.id_, 1,'*📬¦ الزخرفه معطله *', 1, 'md') 
end
return false
end
